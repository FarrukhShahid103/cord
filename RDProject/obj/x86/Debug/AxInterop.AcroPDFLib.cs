...
[assembly: System.Windows.Forms.AxHost.TypeLibraryTimeStamp("12/21/2009 6:15:14 PM")]
...
namespace AxAcroPDFLib {
    ...
    [System.ComponentModel.DefaultEvent("OnError")]
    public class AxAcroPDF : System.Windows.Forms.AxHost {
        ...
        protected override void CreateSink() {
            try {
                ...
                this.cookie = new System.Windows.Forms.AxHost.ConnectionPointCookie(this.ocx, this.eventMulticaster, typeof(AcroPDFLib._IAcroAXDocShimEvents));
            }
        ...
        internal void RaiseOnOnError(object sender, System.EventArgs e) {
            if ((this.OnError != null)) {
                this.OnError(sender, e);
            }
        }
        
        internal void RaiseOnOnMessage(object sender, System.EventArgs e) {
    ...
    public class AxAcroPDFEventMulticaster : AcroPDFLib._IAcroAXDocShimEvents {
        ...
        public virtual void OnError() {
            System.EventArgs onerrorEvent = new System.EventArgs();
            this.parent.RaiseOnOnError(this.parent, onerrorEvent);
        }
        
        public virtual void OnMessage() {
            System.EventArgs onmessageEvent = new System.EventArgs();
