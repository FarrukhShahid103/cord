...
{
    public partial class Khasra_English : Form
    {
        ...
        List<eKhasra> oeListKhasra = null;
        ...
        private void Khasra_English_Load(object sender, EventArgs e)
        {
            SetDefaultValues();
        }

        private void txtKhewatNo_Enter(object sender, EventArgs e)
        {
            //SetDefaultValues();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (checkValidArea())
            {
                ...
                if (NewRecord)
                {
                    ...
                    EntityStatus = obKhasra.insertKhasra(oeKhasra);
                ...
                else
                {
                    ...
                    EntityStatus = obKhasra.udpateKhasra(oeKhasra);
                    if (EntityStatus.Success)
                    {
        ...
        private void Khasra_English_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void fillColumnKhasraGrid()
        {
            ...
            dgvTransferArea.HeaderText = "Transfer Area";
            ...
            dgvTransferShare.HeaderText = "Transfer Share";
        ...
        {
            oeKhasra.Khasra_id = Khasra_ID;
            EntityStatus = obKhasra.deleteKhasra(oeKhasra);
            if (EntityStatus.Success)
            {
        ...
        private void cmbKhasraTotalArea_SelectedIndexChanged(object sender, EventArgs e)
        {
