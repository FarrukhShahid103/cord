...
{
    public partial class ScanningForm_Urdu : Form
    {
            ...
            try
            {
                ...
                if (status == 0)
                {
                    ...
                    if (File.Exists(filename))
                    {
                        ...
                        if (info.Success)
                        {
                            lblMsg.Text = "پیپر سکینک کر لیا گیا ہے۔";
                        }
                        else
                        {
                            lblMsg.Text = "غلطی";
        ...
        protected void Save_Pdf()
        {
            ...
            else
            {
                ...
                if (info.Success)
                {
                    lblMsg.Text = "پیپر سکین ہو گیا ہے۔";
                }
                else
                {
                    lblMsg.Text = "Error.";
        ...
        private void ScanningForm_Urdu_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void ScanningForm_Urdu_Load(object sender, EventArgs e)
        {
            if (NewRecord)
            {
                ScanFile();
